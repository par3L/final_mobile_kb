...
class Model:
    ...
    def predict_from_image(self, image_file):
        ...
        Preprocessing untuk model rupiah classification (128x128 RGB).
        '''
        # Open and convert to RGB (3 channels)
        ...
        if self.model_type == 'keras':
            ...
            confidence = float(np.max(predictions))  # Confidence of predicted class
